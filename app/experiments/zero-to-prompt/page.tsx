      ...
      <section className="py-24 bg-zinc-950 border-b border-zinc-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className="px-2.5 py-1 bg-zinc-800 text-zinc-400 rounded-full text-xs font-medium">
              Build Log
            </span>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <article>
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-zinc-900 tracking-tight mb-6">
              The Blinking Cursor
            </h2>
